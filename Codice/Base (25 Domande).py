...
if os.path.exists("Obblighi.txt"):
    ...
    BaseOb = "Scrivi 25 obblighi qua sotto (uno per ogni riga): "
    Ob.write(BaseOb)
    Ob.close
...
if os.path.exists("Verità.txt"):
    ...
    BaseVr = "Scrivi 25 verità qua sotto (uno per ogni riga): "
    Vr.write(BaseVr)
    Vr.close
